							...
							<form className="auth-form" method="POST" onSubmit={authenticate} autoComplete={'off'}>
								...
								<div className="password mb-3">
									<div className="input-group">
										...
										{(validate.validate && validate.validate.password) && <div className={`invalid-feedback text-start`} >
									...
									<div className="extra mt-3 row justify-content-between">
										<div>
											<Link to="/forgot-password" className="text-lightgreen">Forgot password?</Link>
										</div>
									</div>
								</div>
								<div className="text-center">
									<button type="submit" className="btn btn-login w-100 theme-btn mx-auto"><h6 className="mb-0">Log in</h6></button>
								</div>
							</form>
							<div className="auth-option text-center pt-4 text-bold">Don't have an Account? <Link className="text-link text-lightgreen" to="/register" ><h6>Register</h6></Link></div>
						</div>
					</div>
				</div>
			</div>
