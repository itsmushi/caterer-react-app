    ...
    <div className="text-center">
      ...
      <div className="row container mx-auto">
        <div className="col-lg-4 col-md-6 col-sm-6 col-12 my-2">
          <button
            type="submit"
            className="btn btn-white w-100 theme-btn mx-auto"
          >
      ...
      <div className="row bottom-bar text-center">
        <button
          type="submit"
          className="btn btn-logout w-100 theme-btn mx-auto"
        >
          <Link className="forget-link text-link" to="/login">
            <h6 className="mb-0 logout">Log out</h6>
          </Link>
        </button>
      </div>
    </div>
